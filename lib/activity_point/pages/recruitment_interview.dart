...
class RecruitmentInterview extends StatefulWidget {
  const RecruitmentInterview(this.listDetail, {super.key});
  final List<PointSMDT> listDetail;

  @override
  State<RecruitmentInterview> createState() => _RecruitmentInterviewState();
}

class _RecruitmentInterviewState extends State<RecruitmentInterview> {
  @override
