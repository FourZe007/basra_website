...
class WDDProvinsi extends StatefulWidget {
  const WDDProvinsi(this.inputan, this.list, this.setData,
      {this.mode = 1, super.key});

  final String inputan;
  final int mode;
  final List<ModelProvinsi> list;
  final Function setData;

  @override
  State<WDDProvinsi> createState() => _MyPageState();
}

class _MyPageState extends State<WDDProvinsi> {
  @override
          ...
          child: DropdownButton(
            ...
            items: widget.list.map((items) {
              return DropdownMenuItem(
                value: items.bigarea,
                child: Text(items.bigarea, style: GlobalFont.mediumfontR),
              );
            }).toList(),
            onChanged: (newvalues) {
            ...
            isDense: true,
            isExpanded: true,
            hint: Text('Masukkan Provinsi', style: GlobalFont.mediumfontR),
