...
class DropdownAktivitas extends StatefulWidget {
  const DropdownAktivitas(this.listData, this.inputan, this.hint, this.setData, {this.disable = false, super.key});
  ...
  @override
  State<DropdownAktivitas> createState() => _DropdownAktivitasState();
}
