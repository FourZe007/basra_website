...
class WInputCurrency extends StatelessWidget {
  const WInputCurrency(this.input, this.label, this.handle,
      {this.mode = 1, super.key});

  final String input, label;
  final int mode;
    ...
    return Container(
      ...
      child: TextField(
          ...
          decoration: InputDecoration(
              ...
              label: Text(label),
              labelStyle: GlobalFont.mediumfontM,
              contentPadding:
