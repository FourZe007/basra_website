...
class _Dashboard02State extends State<Dashboard02> with AutomaticKeepAliveClientMixin<Dashboard02> {
              ...
              child: Table(
                ...
                children: [
                  TableRow(
                    ...
                    children: [
                      HeaderTable(eGrup, Alignment.center),
                    ...
                    return TableRow(
                      ...
                      children: [
                        Tooltip(
                          ...
                          child: TextTable(item.groupDealer, Alignment.centerLeft, 1),
                        ),
