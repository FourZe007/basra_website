...
class _Dashboard05State extends State<Dashboard05> with AutomaticKeepAliveClientMixin<Dashboard05> {
              ...
              child: Table(
                ...
                children: [
                  TableRow(
                    ...
                    children: [
                      HeaderTable(eKota, Alignment.center),
                    ...
                    return TableRow(
                      ...
                      children: [
                        Tooltip(
                          ...
                          child: TextTable(item.cDistrict, Alignment.centerLeft, 1),
                        ),
